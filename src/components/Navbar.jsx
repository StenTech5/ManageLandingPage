...
//   return (
//     <nav className={`sticky top-0 left-0 w-full z-[50] bg-white transition-shadow duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
//       <div className="flex justify-between items-center px-6 py-6 sm:px-8 md:px-10 lg:px-20 xl:px-32 md:py-8">
//         <img
//           src={assets.logo}
//           className="cursor-pointer w-[130px] sm:w-[150px] h-auto"
...
const Navbar = () => {
  ...
  return (
    <nav className={`sticky top-0 left-0 w-full z-[50] bg-white transition-shadow duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
      <div className="flex justify-between items-center px-6 py-4 sm:px-8 md:px-10 lg:px-20 xl:px-32 md:py-6">
        <img
          src={assets.logo}
          className="cursor-pointer w-[130px] sm:w-[150px] h-auto"
          alt="logo"
